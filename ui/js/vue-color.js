...
function _colorChange(data, oldHue) {
  ...
  return {
    ...
    hexT: Number(color.toHexTString()),
    rgba: color.toRgb(),
    hsv: hsv,
...
exports.default = {
  ...
  methods: {
    ...
    handleChange: function handleChange(e, skip) {
      ...
      var bright = (0, _clamp2.default)(-(top / containerHeight) + 1, 0.05, 1);
...
exports.default = {
  ...
  computed: {
    ...
    gradientColor: function gradientColor() {
      ...
      return '-webkit-linear-gradient(right, rgba(' + rgbStr + ', 0) 0%, rgba(' + rgbStr + ', 1) 100%)';
    }
  },
  methods: {
    handleChange: function handleChange(e, skip) {
...
tinycolor.prototype = {
  ...
  toHexTString: function() {
      return '0x' + this.toHexT();
  },
    toRgb: function() {
